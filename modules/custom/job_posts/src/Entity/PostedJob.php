 ...
 *     "route_provider" = {
 *       "html" = "Drupal\job_posts\PostedJobHtmlRouteProvider",
 *     },
 *   },
 *   base_table = "posted_job",
 *   admin_permission = "administer posted job entities",
 *   entity_keys = {
 *     "id" = "id",
 *     "label" = "name",
 *     "uuid" = "uuid",
 ...
 *     "collection" = "/admin/structure/posted_job",
 *   },
 *   field_ui_base_route = "posted_job.settings"
 * )
 */
class PostedJob extends ContentEntityBase implements PostedJobInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    $fields['id'] = BaseFieldDefinition::create('integer')
      ->setLabel(t('ID'))
      ->setDescription(t('The ID of the Posted job entity.'))
      ->setReadOnly(TRUE);
    $fields['uuid'] = BaseFieldDefinition::create('uuid')
      ->setLabel(t('UUID'))
      ->setDescription(t('The UUID of the Posted job entity.'))
      ->setReadOnly(TRUE);

    $fields['user_id'] = BaseFieldDefinition::create('entity_reference')
      ->setLabel(t('Authored by'))
      ->setDescription(t('The user ID of author of the Posted job entity.'))
    ...
    $fields['name'] = BaseFieldDefinition::create('string')
      ->setLabel(t('Name'))
      ->setDescription(t('The name of the Posted job entity.'))
      ->setSettings(array(
        'max_length' => 50,
        'text_processing' => 0,
      ))
    ...
    $fields['status'] = BaseFieldDefinition::create('boolean')
      ...
      ->setDescription(t('A boolean indicating whether the Posted job is published.'))
      ->setDefaultValue(TRUE);

    $fields['langcode'] = BaseFieldDefinition::create('language')
      ->setLabel(t('Language code'))
      ->setDescription(t('The language code for the Posted job entity.'))
      ->setDisplayOptions('form', array(
